...
class DataIngestion:
    ...
    def export_collection_as_dataframe(self):
        """
        This function exports the collection from the MongoDB as a dataframe
        """
        try:
    ...
    def export_data_to_feature_store(self, dataframe):
        """
        This function exports the data to the feature store
        """
        try:
    ...
    def split_data_as_train_test_split(self, dataframe: pd.DataFrame):
        ...
        try:
            ...
            logging.info("Performed Train Test Split on thr dataframe.")

            logging.info(f"Train Set Shape: {train_set.shape} | Test Set Shape: {test_set.shape}")
            logging.info("Exited split_data_as_train_test_split method of the DataIngestion class")
            ...
            logging.info("Exported Train and Test Set to the respective files.")
